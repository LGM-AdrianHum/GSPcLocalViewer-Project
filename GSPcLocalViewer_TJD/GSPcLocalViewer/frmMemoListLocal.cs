...
{
	public class frmMemoListLocal : Form
	{
		...
		public List<string> lstExportedLocalMemoListPictures = new List<string>();
		...
		public AxDjVuCtrl objDjVuCtlMemoListLocal;
		...
		public frmMemoListLocal(frmMemoList frm)
		{
				...
				try
				{
					...
					if (!(item != string.Empty) || item == null)
					{
						...
						if (process != null)
						{
							...
							frmMemoListLocal.SetForegroundWindow(process.Handle);
						}
					}
					else
					{
						...
						if (str != null)
						{
							...
							if (process1 != null)
							{
								...
								frmMemoListLocal.SetForegroundWindow(process1.Handle);
							}
						}
						else
						{
							...
							if (process2 != null)
							{
								...
								frmMemoListLocal.SetForegroundWindow(process2.Handle);
							}
						}
					}
				}
		...
		public void ClearItems(bool clearPanels, bool clearList, bool clearButtonCheck)
		{
			if (clearPanels)
			{
				...
				if (this.frmParent.objFrmTasks.intMemoType == 2)
				{
					...
					this.objDjVuCtlMemoListLocal.SRC = null;
				}
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				this.objDjVuCtlMemoListLocal.SRC = string.Empty;
		...
		private void frmMemoListLocal_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (this.lstExportedLocalMemoListPictures.Count > 0)
			{
				for (int i = 0; i < this.lstExportedLocalMemoListPictures.Count; i++)
				{
					if (File.Exists(this.lstExportedLocalMemoListPictures[i]))
					{
						File.Delete(this.lstExportedLocalMemoListPictures[i]);
					}
				}
			}
		}
		...
		private string GetResource(string sDefaultValue, string sKey, ResourceType rType)
		{
			...
			try
			{
				...
				str = string.Concat(str, "/Screen[@Name='MEMOLIST_LOCAL']");
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmMemoListLocal));
			this.objDjVuCtlMemoListLocal = new AxDjVuCtrl();
			...
			((ISupportInitialize)this.objDjVuCtlMemoListLocal).BeginInit();
			...
			base.SuspendLayout();
			this.objDjVuCtlMemoListLocal.Dock = DockStyle.Fill;
			this.objDjVuCtlMemoListLocal.Enabled = true;
			this.objDjVuCtlMemoListLocal.Location = new Point(0, 0);
			this.objDjVuCtlMemoListLocal.Name = "objDjVuCtlMemoListLocal";
			this.objDjVuCtlMemoListLocal.OcxState = (AxHost.State)componentResourceManager.GetObject("objDjVuCtlMemoListLocal.OcxState");
			this.objDjVuCtlMemoListLocal.Size = new System.Drawing.Size(406, 42);
			this.objDjVuCtlMemoListLocal.TabIndex = 0;
			this.pnlControl.Controls.Add(this.btnOK);
			this.pnlControl.Controls.Add(this.btnCancel);
			this.pnlControl.Dock = DockStyle.Bottom;
			this.pnlControl.Location = new Point(0, 378);
			...
			this.pnlForm.Size = new System.Drawing.Size(450, 411);
			...
			this.pnlBottom.Size = new System.Drawing.Size(448, 218);
			...
			this.pnlMemos.Size = new System.Drawing.Size(428, 210);
			...
			this.pnlTxtMemo.Size = new System.Drawing.Size(428, 210);
			...
			this.pnlTxtMemoContents.Size = new System.Drawing.Size(406, 172);
			...
			this.pnlRtbTxtMemo.Size = new System.Drawing.Size(402, 161);
			...
			this.rtbTxtMemo.Size = new System.Drawing.Size(400, 159);
			...
			this.pnlRefMemo.Size = new System.Drawing.Size(428, 210);
			...
			this.pnlRefMemoContents.Size = new System.Drawing.Size(406, 177);
			...
			this.pnlPrgMemo.Size = new System.Drawing.Size(428, 210);
			...
			this.pnlPrgMemoContents.Size = new System.Drawing.Size(406, 177);
			...
			this.pnlError.Size = new System.Drawing.Size(428, 210);
			this.pnlError.TabIndex = 0;
			this.lblError.Dock = DockStyle.Fill;
			this.lblError.Location = new Point(10, 0);
			this.lblError.Name = "lblError";
			this.lblError.Size = new System.Drawing.Size(406, 198);
			...
			this.pnlHypMemo.Size = new System.Drawing.Size(428, 210);
			...
			this.pnlHypMemoPreview.Controls.Add(this.objDjVuCtlMemoListLocal);
			...
			this.pnlHypMemoPreview.Size = new System.Drawing.Size(406, 42);
			...
			this.picBoxHypPreview.Size = new System.Drawing.Size(406, 42);
			...
			this.pnlOptions.Controls.Add(this.lblLocalMemo);
			...
			base.ClientSize = new System.Drawing.Size(450, 411);
			...
			base.Name = "frmMemoListLocal";
			base.Load += new EventHandler(this.frmMemoLocal_Load);
			base.FormClosing += new FormClosingEventHandler(this.frmMemoListLocal_FormClosing);
			((ISupportInitialize)this.objDjVuCtlMemoListLocal).EndInit();
		...
		private void objDjVuCtlMemoListLocal_PageChange(object sender, _DDjVuCtrlEvents_PageChangeEvent e)
		{
			try
			{
		...
		{
			if (this.objDjVuCtlMemoListLocal.InvokeRequired)
			{
				AxDjVuCtrl axDjVuCtrl = this.objDjVuCtlMemoListLocal;
				frmMemoListLocal.ShowDJVUDelegate showDJVUDelegate = new frmMemoListLocal.ShowDJVUDelegate(this.ShowDJVU);
			...
			if (!bState)
			{
				this.objDjVuCtlMemoListLocal.SendToBack();
				this.picBoxHypPreview.BringToFront();
				return;
			}
			this.objDjVuCtlMemoListLocal.BringToFront();
			this.picBoxHypPreview.SendToBack();
			this.pnlHypMemoPreview.AutoScrollMinSize = new System.Drawing.Size(0, 0);
			this.objDjVuCtlMemoListLocal.Zoom = "100";
			this.objDjVuCtlMemoListLocal.Toolbar = "1";
			this.objDjVuCtlMemoListLocal.SRC = sSource;
		}
						...
						else
						{
							...
							else
							{
								if (this.txtHypMemoUrl.Text.Trim().StartsWith("http://") || this.txtHypMemoUrl.Text.Trim().StartsWith("https://"))
								{
									...
									this.lstExportedLocalMemoListPictures.Add(this.strDjVuPicPath);
								}
								else
								{
								...
								else
								{
									...
									if (this.objDjVuCtlMemoListLocal.SRC == "")
									{
										this.lblHypMemoNote.Text = this.GetResource("Can not preview. Please refer directly by pressing the Browse button.", "PROVIDE_URL_NEW", ResourceType.LABEL);
										this.lblHypMemoNote.Show();
									}
