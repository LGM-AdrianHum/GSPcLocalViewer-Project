...
namespace GSPcLocalViewer
{
	public class frmPartNameAdvSrch : Form
	{
		...
		private void AddRowToBooksGrid()
		{
			...
			{
				this.dgvBooks.Invoke(new frmPartNameAdvSrch.AddRowToBooksGridDelegate(this.AddRowToBooksGrid));
				return;
			}
		...
		private void AddRowToResultsGrid()
		{
			...
			{
				this.dgvSearchResults.Invoke(new frmPartNameAdvSrch.AddRowToResultsGridDelegate(this.AddRowToResultsGrid));
				return;
			}
		...
		private void ChangeSearchButtonText(string caption, bool isSearching)
		{
			...
			frmPartNameAdvSrch.ChangeSearchButtonTextDelegate changeSearchButtonTextDelegate = new frmPartNameAdvSrch.ChangeSearchButtonTextDelegate(this.ChangeSearchButtonText);
		...
		private void EnableDisableSearchControls(bool value)
		{
			if (this.pnlSearchCriteria.InvokeRequired)
			{
				...
				frmPartNameAdvSrch.EnableDisableSearchControlsDelegate enableDisableSearchControlsDelegate = new frmPartNameAdvSrch.EnableDisableSearchControlsDelegate(this.EnableDisableSearchControls);
		...
		private DataGridViewColumnCollection GetBooksColumns()
		{
			...
			return (DataGridViewColumnCollection)this.dgvBooks.Invoke(new frmPartNameAdvSrch.GetBooksColumnsDelegate(this.GetBooksColumns));
		}
		...
		private bool GetExactMatch()
		{
			...
			return (bool)this.chkExactMatch.Invoke(new frmPartNameAdvSrch.GetExaceMatchDelegate(this.GetExactMatch));
		}
		...
		private string GetKeyword()
		{
			...
			return (string)this.ltbKeyword.Invoke(new frmPartNameAdvSrch.GetKeywordDelegate(this.GetKeyword));
		}
		...
		private bool GetMatchCase()
		{
			...
			return (bool)this.chkMatchCase.Invoke(new frmPartNameAdvSrch.GetMatchCaseDelegate(this.GetMatchCase));
		}
		...
		private string GetResource(string sDefaultValue, string sKey, ResourceType rType)
		{
			...
			try
			{
				...
				str = string.Concat(str, "/Screen[@Name='PART_NAME_ADVSEARCH']");
				if (rType != ResourceType.TITLE)
				{
					...
					else if (rType == ResourceType.CHECKBOX)
					{
						str = string.Concat(str, "/Resources[@Name='CHECKBOX']");
					}
		...
		private ArrayList GetSelectedBookRows()
		{
			if (this.dgvBooks.InvokeRequired)
			{
				return (ArrayList)this.dgvBooks.Invoke(new frmPartNameAdvSrch.GetSelectedBookRowsDelegate(this.GetSelectedBookRows));
			}
		...
		private void HideLoading(Panel parentPanel)
		{
			try
			{
				...
				{
					frmPartNameAdvSrch.HideLoadingDelegate hideLoadingDelegate = new frmPartNameAdvSrch.HideLoadingDelegate(this.HideLoading);
		...
		private void InitializeBooksGrid(XmlNode xSchemaNode)
		{
			if (this.dgvBooks.InvokeRequired)
			{
				...
				frmPartNameAdvSrch.InitializeBooksGridDelegate initializeBooksGridDelegate = new frmPartNameAdvSrch.InitializeBooksGridDelegate(this.InitializeBooksGrid);
		...
		private void InitializeResultsGrid(XmlNode xPageSchema, XmlNode xPartSchema)
		{
			if (this.dgvSearchResults.InvokeRequired)
			{
				...
				frmPartNameAdvSrch.InitializeResultsGridDelegate initializeResultsGridDelegate = new frmPartNameAdvSrch.InitializeResultsGridDelegate(this.InitializeResultsGrid);
			...
			try
			{
				...
				ArrayList arrayLists = new ArrayList();
				IniFileIO iniFileIO = new IniFileIO();
				arrayLists = iniFileIO.GetKeys(string.Concat(Application.StartupPath, "\\GSP_", this.sServerKey, ".ini"), "BOOKS_PARTNAME_ADVSEARCH");
				List<DataGridViewTextBoxColumn> dataGridViewTextBoxColumns = new List<DataGridViewTextBoxColumn>();
				if (arrayLists.Count <= 0)
				{
					...
					if (booksColumns != null && booksColumns.Count > 0)
					{
						foreach (DataGridViewColumn booksColumn in booksColumns)
						{
							...
							DataGridViewTextBoxColumn dataGridViewTextBoxColumn2 = new DataGridViewTextBoxColumn()
							{
								...
								HeaderText = this.GetGridLanguage(booksColumn.HeaderText, this.sServerKey),
								AutoSizeMode = DataGridViewAutoSizeColumnMode.None,
								Width = 80
							};
					...
					try
					{
						foreach (XmlAttribute attribute1 in xPartSchema.Attributes)
						{
							...
							for (int i = 0; i < arrayLists.Count; i++)
							{
								...
								{
									string keyValue = iniFileIO.GetKeyValue("BOOKS_PARTNAME_ADVSEARCH", arrayLists[i].ToString(), string.Concat(Application.StartupPath, "\\GSP_", this.sServerKey, ".ini"));
									string[] strArrays = keyValue.Split(new char[] { '|' });
									try
									{
										if (strArrays[0].ToString().ToUpper() == "TRUE")
									...
									try
									{
										...
										{
											dGHeaderCellValue.HeaderText = Global.GetDGHeaderCellValue("BOOKS_PARTNAME_ADVSEARCH", upper1, strArrays[1], this.p_ServerId);
										}
									}
									catch (Exception exception1)
									{
						...
						foreach (XmlAttribute xmlAttribute1 in xPageSchema.Attributes)
						{
							...
							DataGridViewTextBoxColumn num = new DataGridViewTextBoxColumn()
							{
								...
								HeaderText = this.GetGridLanguage(xmlAttribute1.Value, this.sServerKey),
								AutoSizeMode = DataGridViewAutoSizeColumnMode.None
							};
							...
							for (int j = 0; j < arrayLists.Count; j++)
							{
								...
								{
									string keyValue1 = iniFileIO.GetKeyValue("BOOKS_PARTNAME_ADVSEARCH", arrayLists[j].ToString(), string.Concat(Application.StartupPath, "\\GSP_", this.sServerKey, ".ini"));
									...
									try
									{
										...
										{
											num.HeaderText = Global.GetDGHeaderCellValue("BOOKS_PARTNAME_ADVSEARCH", upper2, strArrays1[1], this.frmParent.frmParent.ServerId);
										}
									}
									catch (Exception exception5)
									{
							...
							foreach (DataGridViewColumn dataGridViewColumn in dataGridViewTextBoxColumns)
							{
								if (!(dataGridViewColumn.Tag.ToString().ToUpper() != string.Empty) || !dataGridViewColumn.Visible || !(dataGridViewColumn.Tag.ToString().ToUpper() == num.Tag.ToString().ToUpper()))
								{
									continue;
								}
								flag = true;
						...
						{
							foreach (DataGridViewColumn booksColumn1 in dataGridViewColumnCollections)
							{
								if (booksColumn1.Name.ToUpper() == "CHK")
								{
									continue;
								}
								DataGridViewTextBoxColumn dGHeaderCellValue1 = new DataGridViewTextBoxColumn()
								{
									Name = string.Concat("BOOK::", booksColumn1.Name),
									Tag = booksColumn1.Tag.ToString(),
									HeaderText = this.GetGridLanguage(booksColumn1.HeaderText, this.sServerKey),
									AutoSizeMode = DataGridViewAutoSizeColumnMode.None,
									Width = 80
								};
								string upper3 = booksColumn1.Tag.ToString().ToUpper();
								dGHeaderCellValue1.Visible = false;
								for (int k = 0; k < arrayLists.Count; k++)
								{
									if (upper3 == arrayLists[k].ToString().Trim())
									{
										string keyValue2 = iniFileIO.GetKeyValue("BOOKS_PARTNAME_ADVSEARCH", arrayLists[k].ToString(), string.Concat(Application.StartupPath, "\\GSP_", this.sServerKey, ".ini"));
										string[] strArrays2 = keyValue2.Split(new char[] { '|' });
										try
										{
											if (strArrays2[0].ToString().ToUpper() == "TRUE")
											{
												dGHeaderCellValue1.Visible = true;
											}
										}
										...
										try
										{
											if (Settings.Default.appLanguage.ToUpper() == "ENGLISH")
											{
												dGHeaderCellValue1.HeaderText = strArrays2[1];
											}
											else
											{
												dGHeaderCellValue1.HeaderText = Global.GetDGHeaderCellValue("BOOKS_PARTNAME_ADVSEARCH", upper3, strArrays2[1], this.frmParent.frmParent.ServerId);
											}
										}
										...
										try
										{
											...
											if (str5 != null)
											{
												if (str6 == "L")
												{
													dGHeaderCellValue1.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
													goto Label4;
												}
												else if (str6 == "R")
												{
													dGHeaderCellValue1.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
													goto Label4;
												}
												else
												{
													...
													dGHeaderCellValue1.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
													goto Label4;
												}
											}
										Label8:
										...
										try
										{
											dGHeaderCellValue1.Width = Convert.ToInt32(strArrays2[3]);
										}
								...
								{
									if (!(column.Tag.ToString() != string.Empty) || !column.Visible || !(column.Tag.ToString().ToUpper() == dGHeaderCellValue1.Tag.ToString().ToUpper()))
									{
										continue;
									}
									flag1 = true;
								...
								dataGridViewTextBoxColumns.Add(dGHeaderCellValue1);
							}
						}
						try
						{
							for (int l = 0; l < arrayLists.Count; l++)
							{
								foreach (DataGridViewColumn dataGridViewColumn1 in dataGridViewTextBoxColumns)
								{
									...
									else
									{
										...
										{
											if (!(column1.Tag.ToString() != string.Empty) || !column1.Visible || !(column1.Tag.ToString().ToUpper() == dataGridViewColumn1.Tag.ToString().ToUpper()))
											{
												continue;
											}
											flag2 = true;
							...
							foreach (DataGridViewColumn dataGridViewColumn2 in dataGridViewTextBoxColumns)
							{
								...
								{
									if (!(column2.Tag.ToString() != string.Empty) || !column2.Visible || !(column2.Tag.ToString().ToUpper() == dataGridViewColumn2.Tag.ToString().ToUpper()))
									{
										continue;
									}
									flag3 = true;
		...
		private void ShowLoading(Panel parentPanel)
		{
			try
			{
				...
				{
					frmPartNameAdvSrch.ShowLoadingDelegate showLoadingDelegate = new frmPartNameAdvSrch.ShowLoadingDelegate(this.ShowLoading);
					object[] objArray = new object[] { parentPanel };
		...
		private void ShowResultGrid()
		{
			...
			this.pnlSearchResults.Invoke(new frmPartNameAdvSrch.ShowResultGridDelegate(this.ShowResultGrid));
		}
		...
		private void ShowResultMessage(string msg)
		{
			...
			frmPartNameAdvSrch.ShowResultMessageDelegate showResultMessageDelegate = new frmPartNameAdvSrch.ShowResultMessageDelegate(this.ShowResultMessage);
		...
		private void UpdateStatus()
		{
			if (this == this.frmParent.GetCurrentChildForm())
			{
				if (this.frmParent.InvokeRequired)
				{
					...
					frmPartNameAdvSrch.StatusDelegate statusDelegate = new frmPartNameAdvSrch.StatusDelegate(this.frmParent.UpdateStatus);
