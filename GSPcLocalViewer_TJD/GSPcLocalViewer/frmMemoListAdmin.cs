...
{
	public class frmMemoListAdmin : Form
	{
		...
		public System.Windows.Forms.ContextMenuStrip cmsAllMemo;
		...
		public Panel pnlHypMemoPreview;

		public PictureBox picBoxHypPreview;

		public AxDjVuCtrl objDjVuCtlAdminMemoList;

		public Panel pnlHypMemoContents;
		...
		public List<string> lstExportedAdminMemoListPictures = new List<string>();
		...
		public frmMemoListAdmin(frmMemoList frm)
		{
				...
				try
				{
					...
					if (!(item != string.Empty) || item == null)
					{
						...
						if (process != null)
						{
							...
							frmMemoListAdmin.SetForegroundWindow(process.Handle);
						}
					}
					else
					{
						...
						if (str != null)
						{
							...
							if (process1 != null)
							{
								...
								frmMemoListAdmin.SetForegroundWindow(process1.Handle);
							}
						}
						else
						{
							...
							if (process2 != null)
							{
								...
								frmMemoListAdmin.SetForegroundWindow(process2.Handle);
							}
						}
					}
				}
		...
		public void ClearItems(bool clearPanels, bool clearList, bool clearButtonCheck)
		{
			if (clearPanels)
			{
				...
				if (this.frmParent.objFrmTasks.intMemoType == 2)
				{
					...
					this.objDjVuCtlAdminMemoList.SRC = null;
				}
		...
		protected override void Dispose(bool disposing)
		{
			try
			{
				this.objDjVuCtlAdminMemoList.SRC = string.Empty;
		...
		private void frmMemoListAdmin_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (this.lstExportedAdminMemoListPictures.Count > 0)
			{
				for (int i = 0; i < this.lstExportedAdminMemoListPictures.Count; i++)
				{
					if (File.Exists(this.lstExportedAdminMemoListPictures[i]))
					{
						File.Delete(this.lstExportedAdminMemoListPictures[i]);
					}
				}
			}
		}
		...
		private string GetResource(string sDefaultValue, string sKey, ResourceType rType)
		{
			...
			try
			{
				...
				str = string.Concat(str, "/Screen[@Name='MEMOLIST_ADMIN']");
			...
			try
			{
				...
				try
				{
					...
					if (!Settings.Default.OpenInCurrentInstance)
					{
						...
						if (Global.SecurityLocksOpen(this.frmParent.frmParent.GetBookNode(xmlNodes.Attributes["BookId"].Value, -1), this.frmParent.frmParent.SchemaNode, this.frmParent.frmParent.ServerId, this.frmParent.frmParent))
						{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(frmMemoListAdmin));
			this.objDjVuCtlAdminMemoList = new AxDjVuCtrl();
			...
			((ISupportInitialize)this.objDjVuCtlAdminMemoList).BeginInit();
			...
			base.SuspendLayout();
			this.objDjVuCtlAdminMemoList.Dock = DockStyle.Fill;
			this.objDjVuCtlAdminMemoList.Enabled = true;
			this.objDjVuCtlAdminMemoList.Location = new Point(0, 0);
			this.objDjVuCtlAdminMemoList.Name = "objDjVuCtlAdminMemoList";
			this.objDjVuCtlAdminMemoList.OcxState = (AxHost.State)componentResourceManager.GetObject("objDjVuCtlAdminMemoList.OcxState");
			this.objDjVuCtlAdminMemoList.Size = new System.Drawing.Size(406, 0);
			this.objDjVuCtlAdminMemoList.TabIndex = 0;
			this.objDjVuCtlAdminMemoList.PageChange += new _DDjVuCtrlEvents_PageChangeEventHandler(this.objDjVuCtlAdminMemoList_PageChange);
			...
			this.pnlTop.Size = new System.Drawing.Size(448, 126);
			...
			this.pnlGrid.Size = new System.Drawing.Size(428, 116);
			...
			this.dgMemoList.Size = new System.Drawing.Size(426, 114);
			...
			this.pnlBottom.Location = new Point(0, 159);
			this.pnlBottom.Name = "pnlBottom";
			this.pnlBottom.Padding = new System.Windows.Forms.Padding(10, 0, 10, 0);
			this.pnlBottom.Size = new System.Drawing.Size(448, 158);
			...
			this.pnlMemos.Size = new System.Drawing.Size(428, 150);
			...
			this.pnlTxtMemo.Size = new System.Drawing.Size(428, 150);
			...
			this.pnlTxtMemoContents.Size = new System.Drawing.Size(406, 112);
			...
			this.pnlRtbTxtMemo.Size = new System.Drawing.Size(402, 101);
			...
			this.rtbTxtMemo.Size = new System.Drawing.Size(400, 99);
			...
			this.pnlRefMemo.Size = new System.Drawing.Size(428, 150);
			...
			this.pnlRefMemoContents.Size = new System.Drawing.Size(406, 117);
			...
			this.pnlPrgMemo.Size = new System.Drawing.Size(428, 150);
			...
			this.pnlPrgMemoContents.Size = new System.Drawing.Size(406, 117);
			...
			this.pnlError.Size = new System.Drawing.Size(428, 150);
			this.pnlError.TabIndex = 0;
			this.lblError.Dock = DockStyle.Fill;
			this.lblError.Location = new Point(10, 0);
			this.lblError.Name = "lblError";
			this.lblError.Size = new System.Drawing.Size(406, 138);
			...
			this.pnlHypMemo.Size = new System.Drawing.Size(428, 150);
			...
			this.pnlHypMemoPreview.Controls.Add(this.objDjVuCtlAdminMemoList);
			...
			this.pnlOptions.Controls.Add(this.lblAdminMemo);
			...
			base.Name = "frmMemoListAdmin";
			base.FormClosing += new FormClosingEventHandler(this.frmMemoListAdmin_FormClosing);
			((ISupportInitialize)this.objDjVuCtlAdminMemoList).EndInit();
		...
		private void objDjVuCtlAdminMemoList_PageChange(object sender, _DDjVuCtrlEvents_PageChangeEvent e)
		{
			try
			{
		...
		{
			if (this.objDjVuCtlAdminMemoList.InvokeRequired)
			{
				AxDjVuCtrl axDjVuCtrl = this.objDjVuCtlAdminMemoList;
				frmMemoListAdmin.ShowDJVUDelegate showDJVUDelegate = new frmMemoListAdmin.ShowDJVUDelegate(this.ShowDJVU);
			...
			if (!bState)
			{
				this.objDjVuCtlAdminMemoList.SendToBack();
				this.picBoxHypPreview.BringToFront();
				return;
			}
			this.objDjVuCtlAdminMemoList.BringToFront();
			this.picBoxHypPreview.SendToBack();
			this.pnlHypMemoPreview.AutoScrollMinSize = new System.Drawing.Size(0, 0);
			this.picBoxHypPreview.SendToBack();
			this.objDjVuCtlAdminMemoList.Zoom = "100";
			this.objDjVuCtlAdminMemoList.Toolbar = "1";
			this.objDjVuCtlAdminMemoList.SRC = sSource;
		}
			...
			if (this.txtHypMemoUrl.Text.Trim() != string.Empty)
			{
				try
				{
					if (this.frmParent.objFrmTasks.intMemoType == 2)
					{
						...
						bool flag = false;
						string str = fileExtension.ToString().Trim();
						string str1 = str;
						if (str != null)
						{
							switch (str1)
						...
						else
						{
							...
							else
							{
								...
								if (this.txtHypMemoUrl.Text.Trim().StartsWith("http://") || this.txtHypMemoUrl.Text.Trim().StartsWith("https://"))
								{
									...
									this.lstExportedAdminMemoListPictures.Add(this.strDjVuPicPath);
								}
								else
								{
								...
								else
								{
									...
									if (this.objDjVuCtlAdminMemoList.SRC == "")
									{
										this.lblHypMemoNote.Text = this.GetResource("Can not preview. Please refer directly by pressing the Browse button.", "PROVIDE_URL_NEW", ResourceType.LABEL);
										this.lblHypMemoNote.Show();
									}
