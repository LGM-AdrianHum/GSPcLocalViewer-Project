...
// Type: GSPcLocalViewer.frmMemoListLocal
  ...
  public class frmMemoListLocal : Form
  {
    ...
    private void frmMemoListLocal_FormClosing(object sender, FormClosingEventArgs e)
    {
      if (this.lstExportedLocalMemoListPictures.Count <= 0)
        return;
      for (int index = 0; index < this.lstExportedLocalMemoListPictures.Count; ++index)
      {
        if (File.Exists(this.lstExportedLocalMemoListPictures[index]))
          File.Delete(this.lstExportedLocalMemoListPictures[index]);
      }
    }
              ...
              case "GIF":
                if (!flag)
                {
                  ...
                  if (this.txtHypMemoUrl.Text.ToUpper().EndsWith("DJVU"))
                  {
                    ...
                    this.objDjVuCtlMemoListLocal.SRC = (string) null;
    ...
    private string GetResource(string sDefaultValue, string sKey, ResourceType rType)
    {
      try
      {
        string str = "" + "/Screen[@Name='MEMO_LIST']" + "/Screen[@Name='MEMOLIST_LOCAL']";
        switch (rType)
        {
    ...
    private void ShowDJVU(bool bState, string sSource)
    {
      if (this.objDjVuCtlMemoListLocal.InvokeRequired)
        this.objDjVuCtlMemoListLocal.Invoke((Delegate) new frmMemoListLocal.ShowDJVUDelegate(this.ShowDJVU), (object) bState, (object) sSource);
      else if (bState)
      {
    ...
    private void InitializeComponent()
    {
      ...
      this.objDjVuCtlMemoListLocal.BeginInit();
      ...
      this.objDjVuCtlMemoListLocal.Size = new Size(406, 42);
      ...
      this.pnlForm.Size = new Size(450, 411);
      ...
      this.pnlBottom.Size = new Size(448, 218);
      ...
      this.pnlMemos.Size = new Size(428, 210);
      ...
      this.pnlTxtMemo.Size = new Size(428, 210);
      ...
      this.pnlTxtMemoContents.Size = new Size(406, 172);
      ...
      this.pnlRtbTxtMemo.Size = new Size(402, 161);
      ...
      this.rtbTxtMemo.Size = new Size(400, 159);
      ...
      this.pnlRefMemo.Size = new Size(428, 210);
      ...
      this.pnlRefMemoContents.Size = new Size(406, 177);
      ...
      this.pnlPrgMemo.Size = new Size(428, 210);
      ...
      this.pnlPrgMemoContents.Size = new Size(406, 177);
      ...
      this.picBoxHypPreview.Size = new Size(406, 42);
      ...
      this.pnlOptions.Controls.Add((Control) this.lblLocalMemo);
      ...
      this.lblLocalMemo.Size = new Size(129, 27);
      ...
      this.ClientSize = new Size(450, 411);
      this.Controls.Add((Control) this.pnlForm);
      this.Font = new Font("Tahoma", 8.25f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      this.FormBorderStyle = FormBorderStyle.None;
      this.Name = nameof (frmMemoListLocal);
      this.Load += new EventHandler(this.frmMemoLocal_Load);
      this.FormClosing += new FormClosingEventHandler(this.frmMemoListLocal_FormClosing);
      this.objDjVuCtlMemoListLocal.EndInit();
