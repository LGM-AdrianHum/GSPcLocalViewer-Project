...
// Type: GSPcLocalViewer.frmPartNumberAdvSrch
...
namespace GSPcLocalViewer
{
  public class frmPartNumberAdvSrch : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (frmPartNumberAdvSrch);
    ...
    private void EnableDisableSearchControls(bool value)
    {
      ...
      {
        this.pnlSearchCriteria.Invoke((Delegate) new frmPartNumberAdvSrch.EnableDisableSearchControlsDelegate(this.EnableDisableSearchControls), (object) value);
      }
      else
      {
        if (this.cmbServers.Items.Count != 2)
    ...
    private void ShowLoading(Panel parentPanel)
    {
      try
      {
        ...
        {
          parentPanel.Invoke((Delegate) new frmPartNumberAdvSrch.ShowLoadingDelegate(this.ShowLoading), (object) parentPanel);
        }
        else
        {
    ...
    private void HideLoading(Panel parentPanel)
    {
      try
      {
        if (parentPanel.InvokeRequired)
        {
          parentPanel.Invoke((Delegate) new frmPartNumberAdvSrch.HideLoadingDelegate(this.HideLoading), (object) parentPanel);
        }
        else
        {
          foreach (Control control in (ArrangedElementCollection) parentPanel.Controls)
    ...
    private void UpdateStatus()
    {
      ...
      if (this.frmParent.InvokeRequired)
        this.frmParent.Invoke((Delegate) new frmPartNumberAdvSrch.StatusDelegate(this.frmParent.UpdateStatus), (object) this.statusText);
      else
    ...
    private void AddRowToBooksGrid()
    {
      ...
      {
        this.dgvBooks.Invoke((Delegate) new frmPartNumberAdvSrch.AddRowToBooksGridDelegate(this.AddRowToBooksGrid));
      }
      else
      {
    ...
    private void AddRowToResultsGrid()
    {
      ...
      {
        this.dgvSearchResults.Invoke((Delegate) new frmPartNumberAdvSrch.AddRowToResultsGridDelegate(this.AddRowToResultsGrid));
      }
      else
      {
    ...
    private void ChangeSearchButtonText(string caption, bool isSearching)
    {
      ...
      {
        this.btnSearch.Invoke((Delegate) new frmPartNumberAdvSrch.ChangeSearchButtonTextDelegate(this.ChangeSearchButtonText), (object) caption, (object) isSearching);
      }
      else
      {
    ...
    private void ShowResultMessage(string msg)
    {
      ...
      {
        this.pnlrtbNoDetails.Invoke((Delegate) new frmPartNumberAdvSrch.ShowResultMessageDelegate(this.ShowResultMessage), (object) msg);
      }
      else
      {
    ...
    private void ShowResultGrid()
    {
      if (this.pnlSearchResults.InvokeRequired)
        this.pnlSearchResults.Invoke((Delegate) new frmPartNumberAdvSrch.ShowResultGridDelegate(this.ShowResultGrid));
      else
    ...
    private void InitializeResultsGrid(XmlNode xPageSchema, XmlNode xPartSchema)
    {
      if (this.dgvSearchResults.InvokeRequired)
      {
        this.dgvSearchResults.Invoke((Delegate) new frmPartNumberAdvSrch.InitializeResultsGridDelegate(this.InitializeResultsGrid), (object) xPageSchema, (object) xPartSchema);
      }
      else
      {
        this.dgvSearchResults.Rows.Clear();
        ...
        ArrayList keys = iniFileIo.GetKeys(Application.StartupPath + "\\GSP_" + this.sServerKey + ".ini", "BOOKS_PARTNUMBER_ADVSEARCH");
          ...
          foreach (XmlAttribute attribute in (XmlNamedNodeMap) xPartSchema.Attributes)
          {
            if (attribute.Name != null && attribute.Value != null && (attribute.Name.Trim() != string.Empty && attribute.Value.Trim() != string.Empty))
            {
              ...
              for (int index = 0; index < keys.Count; ++index)
              {
                ...
                {
                  string[] strArray = iniFileIo.GetKeyValue("BOOKS_PARTNUMBER_ADVSEARCH", keys[index].ToString(), Application.StartupPath + "\\GSP_" + this.sServerKey + ".ini").Split('|');
                  try
                  {
...
label_14:
                  try
                  {
                    if (Settings.Default.appLanguage.ToUpper() != "ENGLISH")
                      viewTextBoxColumn.HeaderText = Global.GetDGHeaderCellValue("BOOKS_PARTNUMBER_ADVSEARCH", upper, strArray[1], this.p_ServerId);
                    else
            ...
            if (attribute.Name != null && attribute.Value != null && (attribute.Name.Trim() != string.Empty && attribute.Value.Trim() != string.Empty))
            {
              ...
              for (int index = 0; index < keys.Count; ++index)
              {
                if (upper == keys[index].ToString().Trim())
                {
                  ...
                  {
                    if (Settings.Default.appLanguage.ToUpper() != "ENGLISH")
                      viewTextBoxColumn.HeaderText = Global.GetDGHeaderCellValue("BOOKS_PARTNUMBER_ADVSEARCH", upper, strArray[1], this.frmParent.frmParent.ServerId);
                    else
                      viewTextBoxColumn.HeaderText = strArray[1];
                  }
                  catch (Exception ex)
              ...
              {
                if (column.HeaderText != string.Empty && column.Visible && column.HeaderText.ToUpper() == viewTextBoxColumn.HeaderText.ToUpper())
                {
                  flag = true;
                  break;
                }
    ...
    private void InitializeBooksGrid(XmlNode xSchemaNode)
    {
      if (this.dgvBooks.InvokeRequired)
      {
        this.dgvBooks.Invoke((Delegate) new frmPartNumberAdvSrch.InitializeBooksGridDelegate(this.InitializeBooksGrid), (object) xSchemaNode);
      }
      else
      {
        try
...
label_14:
    ...
    private string GetKeyword()
    {
      if (this.ltbKeyword.InvokeRequired)
        return (string) this.ltbKeyword.Invoke((Delegate) new frmPartNumberAdvSrch.GetKeywordDelegate(this.GetKeyword));
    ...
    private bool GetMatchCase()
    {
      if (this.chkMatchCase.InvokeRequired)
        return (bool) this.chkMatchCase.Invoke((Delegate) new frmPartNumberAdvSrch.GetMatchCaseDelegate(this.GetMatchCase));
    ...
    private bool GetExactMatch()
    {
      if (this.chkExactMatch.InvokeRequired)
        return (bool) this.chkExactMatch.Invoke((Delegate) new frmPartNumberAdvSrch.GetExaceMatchDelegate(this.GetExactMatch));
    ...
    {
      if (this.dgvBooks.InvokeRequired)
        return (DataGridViewColumnCollection) this.dgvBooks.Invoke((Delegate) new frmPartNumberAdvSrch.GetBooksColumnsDelegate(this.GetBooksColumns));
    ...
    {
      if (this.dgvBooks.InvokeRequired)
        return (ArrayList) this.dgvBooks.Invoke((Delegate) new frmPartNumberAdvSrch.GetSelectedBookRowsDelegate(this.GetSelectedBookRows));
      ArrayList arrayList = new ArrayList();
      foreach (DataGridViewRow row in (IEnumerable) this.dgvBooks.Rows)
      {
        bool result = false;
    ...
    private void GetResults(object arguments)
    {
      ...
      try
      {
        ...
        string FieldToSearch = "PartNumber";
    ...
    private string GetResource(string sDefaultValue, string sKey, ResourceType rType)
    {
      try
      {
        string str = "" + "/Screen[@Name='OPEN_BOOKS']" + "/Screen[@Name='PART_NUMBER_ADVSEARCH']";
        switch (rType)
        {
