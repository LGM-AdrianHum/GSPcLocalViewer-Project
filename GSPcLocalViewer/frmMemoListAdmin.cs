...
// Type: GSPcLocalViewer.frmMemoListAdmin
...
namespace GSPcLocalViewer
{
  public class frmMemoListAdmin : Form
  {
    ...
    public ContextMenuStrip cmsAllMemo;
    ...
    private void InitializeComponent()
    {
      ...
      this.objDjVuCtlAdminMemoList.BeginInit();
      ...
      this.objDjVuCtlAdminMemoList.Size = new Size(406, 0);
      ...
      this.pnlTop.Size = new Size(448, 126);
      ...
      this.pnlGrid.Size = new Size(428, 116);
      ...
      this.dgMemoList.Size = new Size(426, 114);
      ...
      this.pnlBottom.Size = new Size(448, 158);
      ...
      this.pnlMemos.Size = new Size(428, 150);
      ...
      this.pnlTxtMemo.Size = new Size(428, 150);
      ...
      this.pnlTxtMemoContents.Size = new Size(406, 112);
      ...
      this.pnlRtbTxtMemo.Size = new Size(402, 101);
      ...
      this.rtbTxtMemo.Size = new Size(400, 99);
      ...
      this.pnlRefMemo.Size = new Size(428, 150);
      ...
      this.pnlRefMemoContents.Size = new Size(406, 117);
      ...
      this.pnlPrgMemo.Size = new Size(428, 150);
      ...
      this.pnlPrgMemoContents.Size = new Size(406, 117);
      ...
      this.pnlHypMemo.Size = new Size(428, 150);
      ...
      this.pnlHypMemoPreview.Controls.Add((Control) this.objDjVuCtlAdminMemoList);
      ...
      this.pnlOptions.Controls.Add((Control) this.lblAdminMemo);
      ...
      this.lblAdminMemo.Size = new Size(129, 27);
      ...
      this.Name = nameof (frmMemoListAdmin);
      this.FormClosing += new FormClosingEventHandler(this.frmMemoListAdmin_FormClosing);
      this.objDjVuCtlAdminMemoList.EndInit();
    ...
    private void frmMemoListAdmin_FormClosing(object sender, FormClosingEventArgs e)
    {
      if (this.lstExportedAdminMemoListPictures.Count <= 0)
        return;
      for (int index = 0; index < this.lstExportedAdminMemoListPictures.Count; ++index)
      {
        if (File.Exists(this.lstExportedAdminMemoListPictures[index]))
          File.Delete(this.lstExportedAdminMemoListPictures[index]);
      }
    }
    ...
    private void txtHypMemoUrl_TextChanged(object sender, EventArgs e)
    {
      ...
      try
      {
        if (this.frmParent.objFrmTasks.intMemoType == 2)
        {
          ...
          bool flag = false;
          switch (fileExtension.ToString().Trim())
          {
            case "DJVU":
            case "JPG":
            case "JPEG":
            ...
            case "GIF":
              if (!flag)
              {
                ...
                if (this.txtHypMemoUrl.Text.ToUpper().EndsWith("DJVU"))
                {
                  ...
                  this.objDjVuCtlAdminMemoList.SRC = (string) null;
      ...
      try
      {
        ...
        try
        {
          ...
          else
          {
            ...
            if (!Global.SecurityLocksOpen(this.frmParent.frmParent.GetBookNode(xmlNode.Attributes["BookId"].Value, -1), this.frmParent.frmParent.SchemaNode, this.frmParent.frmParent.ServerId, this.frmParent.frmParent))
              return;
    ...
    private string GetResource(string sDefaultValue, string sKey, ResourceType rType)
    {
      try
      {
        string str = "" + "/Screen[@Name='MEMO_LIST']" + "/Screen[@Name='MEMOLIST_ADMIN']";
        switch (rType)
        {
    ...
    private void ShowDJVU(bool bState, string sSource)
    {
      if (this.objDjVuCtlAdminMemoList.InvokeRequired)
        this.objDjVuCtlAdminMemoList.Invoke((Delegate) new frmMemoListAdmin.ShowDJVUDelegate(this.ShowDJVU), (object) bState, (object) sSource);
      else if (bState)
      {
